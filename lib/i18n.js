  ...
  var process = function () {
    ...
    languages.forEach(function (language) {
      ...
      templates.forEach(function (page) {
        ...
        var t18n = function(language, key){
          return i18n[language] && i18n[language][key] ? i18n[language][key] : key;
        }

        var context = _.extend({}, data, {language: language, i18n: i18n, t18n: t18n}, pageObj.context);
